...
REPOSITORY_LOCATIONS_SPEC = dict(
    ...
    com_github_intel_qatlib = dict(
        ...
        sha256 = "8b8a46897217a806eeca911fe7a5040183fb32897ad20bafedcc07d711436799",
        urls = ["https://downloadmirror.intel.com/777529/{version}.tar.gz"],
        use_category = ["dataplane_ext"],
    ...
    com_github_qat_zstd = dict(
        ...
        project_url = "https://github.com/qiming-007/QAT-ZSTD-Plugin",
        version = "0.1",
        sha256 = "e0d1520539a27342b15b4f77c3bf3714d27d51d729db4c52c037d245937c3366",
        strip_prefix = "QAT-ZSTD-Plugin-{version}",
        urls = ["https://github.com/qiming-007/QAT-ZSTD-Plugin/archive/refs/tags/v{version}.tar.gz"],
        use_category = ["dataplane_ext"],
        extensions = [
            "envoy.compression.zstd.compressor",
            "envoy.compression.zstd.decompressor",
