...
REPOSITORY_LOCATIONS_SPEC = dict(
    ...
    com_github_intel_qatzip = dict(
        ...
        version = "QATzip1.0.9_ENVOY_001",
        sha256 = "a3a766944ea33811a9d964fa2830310d2ce45a6f905d6ce39a8ac6e9b233f052",
        strip_prefix = "QATzip-{version}",
        urls = ["https://github.com/intel/QATzip/archive/{version}.tar.gz"],
        use_category = ["dataplane_ext"],
    ...
    com_github_intel_qat_engine = dict(
        project_name = "qat_engine",
        project_desc = "Intel QuickAssist Technology QAT_Engine Library",
        project_url = "https://github.com/intel/QAT_Engine",
        version = "2063a8cdda763735b6032b1d84ae3ee3ffd19abf",
        sha256 = "d85e1735bd954e15f4dc99aea4e0928f4e6368497d447279523171d93fdbdb17",
        strip_prefix = "QAT_Engine-{version}",
        urls = ["https://github.com/giantcroc/QAT_Engine/archive/{version}.tar.gz"],
        use_category = ["dataplane_ext"],
